...
$MESS['DVS_TYRES'] = 'Поиск шин';
$MESS['DVS_WHEELS'] = 'Поиск дисков';
$MESS['DVS_PARAMS'] = 'По параметрам';
$MESS['DVS_AUTO'] = 'По автомобилям';
$MESS['DVS_PROPD'] = 'Производитель';
$MESS['DVS_WIDTH'] = 'Ширина';
$MESS['DVS_HEIGHT'] = 'Высота';
$MESS['DVS_DIAM'] = 'Диаметр';
$MESS['DVS_SEASON'] = 'Сезон';
$MESS['DVS_PIN'] = 'Шипы';
$MESS['DVS_SEARCH'] = 'Найти шины';
$MESS['DVS_BRAND'] = 'Марка автомобиля';
$MESS['DVS_MODEL'] = 'Модель автомобиля';
$MESS['DVS_YEAR'] = 'Год';
$MESS['DVS_MOD'] = 'Модификация';
$MESS['DVS_PCD'] = 'Диаметр (PCD)';
$MESS['DVS_DIAM_C'] = 'Диаметр ц. отверстия';
$MESS['DVS_WIDTH_T'] = 'Ширина диска';
$MESS['DVS_POS_DIAM'] = 'Посадочный диаметр';
$MESS['DVS_ET'] = 'Вылет (ET)';
