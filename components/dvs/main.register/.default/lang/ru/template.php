...
$MESS["DVS_ERRORS"] = "Некоторые поля заполнены не корректно!";
$MESS["DVS_FIELD_ERROR"] = "Не верно заполнено поле.";
$MESS["DVS_FIELD_LOGIN_DES"] = "Для входа в магазин.";
$MESS["DVS_FIELD_EMAIL_DES"] = "Для уведомлений.";
$MESS["DVS_FIELD_CONF_PASS_DES"] = "Пожалуйста, повторите пароль.";
$MESS["DVS_FIELD_NAME_DES"] = "Представьтесь, пожалуйста.";
$MESS["DVS_FIELD_LAST_NAME_DES"] = "Введите настоящие данные.";
$MESS["DVS_FIELD_ERROR_CAPTCHA"] = 'Не верно введён код с картинки.';
$MESS["DVS_FIELD_CAPTCHA_DES"] = 'Пожалуйста, введите код указанный на картинке.';

$MESS['DVS_TEXT'] = 'Сообщение об успешной регистрации и о том, что на почту выслано письмо со ссылкой, по которой необходимо перейти для подтверждения регистрации.';
$MESS['DVS_REP_CODE'] = 'Повторите код';
